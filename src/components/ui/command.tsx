...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="**:[[cmdk-group]]:px-2 **:[[cmdk-group-heading]]:px-0">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
      ...
      <InputGroup className="h-8 border-none border-input/30 bg-input/30 shadow-none! *:data-[slot=input-group-addon]:pl-2!">
        ...
        {value ? (
          <InputGroupAddon>
            ...
            >
              <XIcon className="size-3.5 shrink-0 opacity-50 hover:opacity-100" />
            </button>
          </InputGroupAddon>
        ) : (
          <InputGroupAddon>
  ...
  return (
    <div className="relative">
      <CommandPrimitive.List
        ...
        className={cn(
          "no-scrollbar max-h-68 scroll-py-0 overflow-x-hidden overflow-y-auto outline-none",
          className
        )}
        {...props}
      />
