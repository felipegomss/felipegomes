...
description: "How the frustration of not being able to send from ola@lfng.dev turned into an email panel with templates, internationalized signature, and server-side protection, all inside the portfolio itself."
date: "2026-04-30"
